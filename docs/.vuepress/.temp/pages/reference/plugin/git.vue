...
<p>The <RouterLink to="/reference/default-theme/config.html#lastupdated">lastUpdated</RouterLink> and <RouterLink to="/reference/default-theme/config.html#contributors">contributors</RouterLink> of default theme is powered by this plugin.</p>
