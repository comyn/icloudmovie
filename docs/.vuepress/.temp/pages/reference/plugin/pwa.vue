...
<p>You need to put your manifest file and icons into the <RouterLink to="/guide/assets.html#public-files">public files directory</RouterLink>. In the following example, we assume that you are using the default public directory <code>.vuepress/public</code>.</p>
<ol>
...
<p>You also need to set some tags via <RouterLink to="/reference/config.html#head">head</RouterLink> option to <a href="https://developer.mozilla.org/en-US/docs/Web/Manifest#deploying_a_manifest_with_the_link_tag" target="_blank" rel="noopener noreferrer">deploy the manifest<OutboundLink/></a>:</p>
...
<ul>
<li>For users, you can use our <RouterLink to="/reference/plugin/pwa-popup.html">pwa-popup</RouterLink> plugin together.</li>
...
<li>
<p>Details:</p>
<p>File path of the generated service worker file, which is relative to the <RouterLink to="/reference/config.html#dest">dest</RouterLink> directory.</p>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  <span class="token function">setup</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    event <span class="token operator">=</span> <span class="token function">usePwaEvent</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
