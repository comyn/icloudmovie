...
<p>你需要将你的 Manifest 文件和图标放置在 <RouterLink to="/zh/guide/assets.html#public-%E6%96%87%E4%BB%B6">Public 目录</RouterLink> 下。在下述的示例中，我们假设你正在使用默认的 Public 目录 <code>.vuepress/public</code> 。</p>
<ol>
...
<p>你还需要通过 <RouterLink to="/zh/reference/config.html#head">head</RouterLink> 配置项来设置一些标签，用来 <a href="https://developer.mozilla.org/en-US/docs/Web/Manifest#deploying_a_manifest_with_the_link_tag" target="_blank" rel="noopener noreferrer">部署你的 Manifest 文件<OutboundLink/></a> 。</p>
...
<ul>
<li>对于用户，你可以配合我们提供的 <RouterLink to="/zh/reference/plugin/pwa-popup.html">pwa-popup</RouterLink> 插件一起使用。</li>
...
<li>
<p>详情：</p>
<p>生成的 Service Worker 文件路径，该路径是 <RouterLink to="/zh/reference/config.html#dest">dest</RouterLink> 目录的相对路径。</p>
