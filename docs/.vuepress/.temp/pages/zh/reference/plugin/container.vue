...
<p>该插件简化了 <a href="https://github.com/markdown-it/markdown-it-container" target="_blank" rel="noopener noreferrer">markdown-it-container<OutboundLink/></a> 的使用方法，但同时也保留了其原本的能力。</p>
<p>默认主题的 <RouterLink to="/zh/reference/default-theme/markdown.html#%E8%87%AA%E5%AE%9A%E4%B9%89%E5%AE%B9%E5%99%A8">自定义容器</RouterLink> 就是由该插件支持的。</p>
<h2 id="容器语法"><a class="header-anchor" href="#容器语法">#</a> 容器语法</h2>
...
<li><code>content</code> 可是任何合法的 Markdown 内容。</li>
</ul>
...
<p>详情：</p>
<p>容器的类型。</p>
<p>它将会被用作 <a href="https://github.com/markdown-it/markdown-it-container#api" target="_blank" rel="noopener noreferrer">markdown-it-container<OutboundLink/></a> 的 <code>name</code> 参数。</p>
</li>
</ul>
...
<li>
<p>详情：</p>
<p><a href="https://github.com/markdown-it/markdown-it-container#api" target="_blank" rel="noopener noreferrer">markdown-it-container<OutboundLink/></a> 的 <code>render</code> 配置项。</p>
...
<li>
<p>详情：</p>
<p><a href="https://github.com/markdown-it/markdown-it-container#api" target="_blank" rel="noopener noreferrer">markdown-it-container<OutboundLink/></a> 的 <code>validate</code> 配置项。</p>
</li>
</ul>
...
<li>
<p>详情：</p>
<p><a href="https://github.com/markdown-it/markdown-it-container#api" target="_blank" rel="noopener noreferrer">markdown-it-container<OutboundLink/></a> 的 <code>marker</code> 配置项。</p>
</li>
</ul>
</template>